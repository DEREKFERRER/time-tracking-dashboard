       ...
       {myData.map((items, index) => (
        <>
            <div key={index} className={`rounded-[15px] relative overflow-hidden h-40 ${bgColor[index]} lg:h-full`}>
                ...
                <div className='bg-DarkBlue  items-center p-6 rounded-[15px]  w-full absolute bottom-0 lg:h-[75%]'>
                    ...
                    <div className='flex items-center justify-between lg:flex-col lg:items-start'>
                        <h2 className='text-[2rem]'>{items.timeframes[selected].current}hrs</h2>
